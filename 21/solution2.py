...
if __name__ == '__main__':
    ...
    # print(allergen_to_ingredient_mapping)

    dangerous_ingredient_list = ','.join(map(
        lambda a: allergen_to_ingredient_mapping[a],
        sorted(allergen_to_ingredient_mapping.keys())
    ))
    print(dangerous_ingredient_list)
